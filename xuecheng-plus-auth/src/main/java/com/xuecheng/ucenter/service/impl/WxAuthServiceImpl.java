...
public class WxAuthServiceImpl implements AuthService {
    ...
    @Value("${weixin.appid}")
    String appid;//得在微信开发平台注册
    @Value("${weixin.secret}")
    String secret;//得在微信开发平台注册
    @Autowired
    ...
    private Map<String,String> getAccess_token(String code){
        ...
        ResponseEntity<String> responseEntity = restTemplate.exchange(wxUrl, HttpMethod.POST, null, String.class);
